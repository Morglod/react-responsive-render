...
var SpaceAround = /** @class */ (function (_super) {
    ...
    SpaceAround.prototype.render = function () {
        ...
        return (React.createElement(Container, { style: { position: 'relative' } },
            React.createElement(responsive_1.Responsive, { fast: true, trackPosition: true, toElement: true, resizeTimeout: timeout, onChange: this.handleChildren }, children),
            React.createElement(responsive_1.Responsive, { fast: true, toElement: true, resizeTimeout: timeout, onChange: this.handleItem }, item ? item(status, style, hiddenStatus) : React.createElement("span", null))));
    };
