...
var ResponsiveItems = /** @class */ (function (_super) {
    ...
    ResponsiveItems.prototype.render = function () {
        var _a = this.props, items = _a.items, renderChildren = _a.children, resizeTimeout = _a.resizeTimeout, rows = _a.rows, minItemWidth = _a.minItemWidth, minItemHeight = _a.minItemHeight;
        return (React.createElement(responsive_1.Responsive, { toElement: true, resizeTimeout: resizeTimeout, children: function (_a) {
